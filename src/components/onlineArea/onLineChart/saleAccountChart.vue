<template>
  <div>
    <div id="saleAccountChart" class="chats" />
  </div>
</template>
...
export default {
  ...
  methods: {
    initChart() {
      var that = this
      this.chart = echarts.init(document.getElementById('saleAccountChart'))
      this.chart.clear()
      var xArr = this.canvasData.goodsDateKeyList
      var yArr = this.canvasData.salesMoneyList
