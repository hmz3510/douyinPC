...
export default {
  ...
  methods: {
    initChart() {
      this.chart = echarts.init(document.getElementById('peakOnline'))
      this.chart.clear()
      var xArr = this.canvasData.dateKeyList
      var yArr = this.canvasData.userCountList
      ...
      this.chart.setOption({
        ...
        tooltip: {
          ...
          formatter: function(data) {
            ...
            htmlStr += '峰值在线：' + data[0].data.label + '<br/>'
            htmlStr += date + '</div>'
            return htmlStr
          }
        },
