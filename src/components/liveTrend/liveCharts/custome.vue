...
export default {
  ...
  methods: {
    initChart() {
      this.chart = echarts.init(document.getElementById('custome'))
      this.chart.clear()
      var xArr = this.canvasData.dateKeyList
      var yArr = this.canvasData.totalUserList
      ...
      this.chart.setOption({
        ...
        tooltip: {
          ...
          formatter: function(data) {
            ...
            htmlStr += '观众人数：' + data[0].data.label + '<br/>'
            htmlStr += date + '</div>'
            return htmlStr
          }
        },
