  ...
  <div>
    ...
    <div class="login-container">
      <el-form ref="forgetFrom" :model="forgetFrom" :rules="forgetRules" class="login-form" autocomplete="on" label-position="left">
        <div class="goBack" @click="goBack"><i class="el-icon-arrow-left">返回</i></div>
        ...
        <div class="loginContent">
          <div class="login-content">
            ...
            <div>
              <el-button :loading="loading" class="loginBtn" type="primary" @click.native.prevent="handleLogin3">确定</el-button>
            </div>
          </div>
        </div>
      </el-form>
    ...
    handleLogin3() {
      this.$refs.forgetFrom.validate(valid => {
        if (valid) {
          ...
          this.loading = true
          setPassword(this.forgetFrom).then(res => {
            this.loading = false
